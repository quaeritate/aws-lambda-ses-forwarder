...
describe('index.js', function() {
  describe('#getEmailKeyPrefix()', function() {
    it('should return the original prefex if not *',
      function(done) {
        var data = {
          config: {
            emailBucket: "bucket",
      ...
      it('should extract the username as the prefix if *',
        function(done) {
          var data = {
            config: {
              emailBucket: "bucket",
        ...
        it('should error if there is more than one recipient if the prefix if *',
          function(done) {
            var data = {
              config: {
                emailBucket: "bucket",
              ...
              recipients: ["jim@example.com", "jane@example.com", "jon@example.com"],
              log: console.log
            };
            index.getEmailKeyPrefix(data)
              .catch(function(err) {
